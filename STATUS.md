...
- Git basis: `codex/pala-1.2.0-release-ready`; initial release-ready commits `f54883f` and `783b315` are on origin; CI remediation is local WIP.
...
- Current network-free source verifier: `passed` (763 tests, 5 expected skips, reproducible ZIP `8F576CAF...33AC`, exit 0; 2026-08-15).
...
incomplete until replacement branch CI proves the required symlink canary and all jobs.
Initial push is `passed`; remediation commit/push and replacement CI are `not-run`.
